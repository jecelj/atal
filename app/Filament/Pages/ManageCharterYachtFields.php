...
class ManageCharterYachtFields extends Page
{
    use \BezhanSalleh\FilamentShield\Traits\HasPageShield;

    protected static ?string $navigationIcon = 'heroicon-o-document-text';

    protected static ?string $navigationLabel = 'Charter Yacht Fields';

    protected static ?string $navigationGroup = 'Configuration';

    protected static ?int $navigationSort = 5;

    protected static string $view = 'filament.pages.manage-charter-yacht-fields';
    ...
    {
        $this->form->fill([
            'fields' => FormFieldConfiguration::forCharterYachts()->ordered()->get()->toArray(),
        ]);
    }
                ...
                Forms\Components\Repeater::make('fields')
                    ->schema([
                        Forms\Components\TextInput::make('field_key')
                            ...
                            ->helperText('Unique identifier for this field (e.g., weekly_price, cabins, berths)'),
                        Forms\Components\TextInput::make('group')
                            ->label('Group')
                            ->helperText('Section name (e.g., Pricing, Technical Information)')
                        ...
                        Forms\Components\Toggle::make('sync_as_taxonomy')
                            ...
                            ->helperText('Sync options as WordPress Taxonomy terms')
                            ->default(false)
                        ...
                        Forms\Components\TagsInput::make('validation_rules')
                            ...
                            ->helperText('e.g., max:255, min:0, numeric'),
                    ])
                    ->reorderable()
                    ->collapsible()
    ...
    public function save(): void
    {
        ...
        // Delete existing fields for charter yachts
        FormFieldConfiguration::forCharterYachts()->delete();

        // Create new fields
        foreach ($data['fields'] as $index => $field) {
            FormFieldConfiguration::create([
                'entity_type' => 'charter_yacht',
