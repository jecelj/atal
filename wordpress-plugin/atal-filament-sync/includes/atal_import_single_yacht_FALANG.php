<?php
// FALANG VERSION - atal_import_single_yacht()
// This is the new version that creates ONE post with Falang translations
// Replace lines 118-495 in importer.php with this function
